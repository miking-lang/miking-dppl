...
// g++ -x c++ Src/LDA/ldaGibbs.cu Src/Utils/*.cpp -o smc.exe -std=c++11 -O3

// nvcc -arch=sm_75 -rdc=true Src/LDA/ldaGibbs.cu Src/Utils/*.cpp -o smc.exe -lcudadevrt -std=c++11 -O3 -D GPU
