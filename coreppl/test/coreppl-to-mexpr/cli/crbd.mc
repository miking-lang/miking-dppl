...
utest r (t 4000 500 "-m mcmc-lightweight --align --cps none"       ) with rhs using e in
utest r (t 4000 500 "-m mcmc-lightweight --align --cps partial"    ) with rhs using e in
utest r (t 4000 500 "-m mcmc-lightweight --align --cps full"       ) with rhs using e in
