...
nvcc -arch=sm_75 -rdc=true -lcudadevrt -I . models/random-examples/mixture.cu -o smc.exe -std=c++11 -O3
g++ -x c++ -I . models/random-examples/mixture.cu -o smc.exe -std=c++11 -O3
*/
