...
# GPU
echo "=============GPU TESTS============="
for test in testStudentClassic testWaitingTime testWaitingTimeDelayed testObserveWaitingTime testObserveWaitingTimeDelayed
do
    rootppl clean
...
for test in testStudentClassic testWaitingTime testObserveWaitingTime
do
