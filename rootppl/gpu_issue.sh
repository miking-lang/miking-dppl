...
echo "Compiling ClaDS classic with stack for the GPU with side-branch simulation turned off"
make clean
make model=models/phylogenetics/clads2/TEMPLATE-clads2-nohidden.cu arch=75 -j$CPUCORES > /dev/null 2> /dev/null
./program 10000 50
